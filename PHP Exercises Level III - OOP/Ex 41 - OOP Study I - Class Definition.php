...
<!DOCTYPE html>
<head>
	<title>Exercise 41 - Object Oriented Programming Classes Definition</title>
</head>
<body>
	<h2>Object Oriented Ex 1 - Class 'Member' Definition with Private Properties and Getters and Setters</h2>
	<?php
